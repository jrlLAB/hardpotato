...
path = 'C://Users/oliver/chi/chi760e.exe'
# Folder where to save the data, it needs to be created previously
folder = 'C://Users/oliver/data'
# Initialization:
setup = potentiostat.Setup(model, path, folder)
...
sens2 = 1e-6    # A/V, current sensitivity of the second working electrode
